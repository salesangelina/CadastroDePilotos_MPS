...
public class Persistencia {
    ...
    /* Ao proteger o construtor nós evitamos que esta classe possa ser 
    *instanciada em qualquer outro lugar do código que não seja a própria classe*/
    
    public static Persistencia persiste;
    ...
    public static void addRecords() {
        ...
        try {
            ...
            for (Piloto p : cadPiloto) {
                ...
                LinkedList<CHT> cadTitulacao = p.getTitulacao();
                outputTitulacao.writeInt(cadTitulacao.size());
                for (CHT tit : cadTitulacao) {
        ...
        try {
            ...
            while (moreRecords){
                ...
                for (i = 0; i < qtde_tit; i++) {
                    ...
                    titulacoes.add(new CHT(anoConc, nomeInst, cidade, uF));
                }
